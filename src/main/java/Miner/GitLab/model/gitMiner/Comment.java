...
public class Comment {
    ...
    public static Comment ofFormat(Miner.GitLab.model.comment.Comment c){
        Comment comment = new Comment();

        comment.setId(c.getId());
        comment.setBody(c.getBody());
        comment.setAuthor(Author__1.ofFormat(c.getAuthor()));
        comment.setCreatedAt(c.getCreated_at());
        comment.setUpdatedAt(c.getUpdated_at());
